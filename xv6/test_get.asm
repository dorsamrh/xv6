...
_test_get:     file format elf32-i386
...
int main(int argc, char *argv[]) {  
  ...
  12:	68 bd 08 00 00       	push   $0x8bd
  17:	6a 01                	push   $0x1
  19:	e8 52 05 00 00       	call   570 <printf>
    set_limit(100);
  1e:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  25:	e8 79 04 00 00       	call   4a3 <set_limit>
    int current=uptime();
  2a:	e8 6c 04 00 00       	call   49b <uptime>
  2f:	89 c3                	mov    %eax,%ebx
    cpu_intensive();
  31:	e8 1a 01 00 00       	call   150 <cpu_intensive>
    int finish=uptime();
  36:	e8 60 04 00 00       	call   49b <uptime>
  ...
  46:	6a 01                	push   $0x1
  48:	e8 23 05 00 00       	call   570 <printf>
    printf(1,"cpu limit : 80%% \n");
  4d:	58                   	pop    %eax
  4e:	5a                   	pop    %edx
  4f:	68 e3 08 00 00       	push   $0x8e3
  54:	6a 01                	push   $0x1
  56:	e8 15 05 00 00       	call   570 <printf>
    set_limit(100);
  5b:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  62:	e8 3c 04 00 00       	call   4a3 <set_limit>
    current=uptime();
  67:	e8 2f 04 00 00       	call   49b <uptime>
  6c:	89 c3                	mov    %eax,%ebx
    cpu_intensive();
  6e:	e8 dd 00 00 00       	call   150 <cpu_intensive>
    finish=uptime();
  73:	e8 23 04 00 00       	call   49b <uptime>
    length=finish-current;
    printf(1,"time taken: %d .\n",length);
  78:	83 c4 0c             	add    $0xc,%esp
    length=finish-current;
  7b:	29 d8                	sub    %ebx,%eax
    printf(1,"time taken: %d .\n",length);
  7d:	50                   	push   %eax
  7e:	68 d1 08 00 00       	push   $0x8d1
  83:	6a 01                	push   $0x1
  85:	e8 e6 04 00 00       	call   570 <printf>
    printf(1,"cpu limit : 50%% \n");
  8a:	59                   	pop    %ecx
  8b:	5b                   	pop    %ebx
  8c:	68 f6 08 00 00       	push   $0x8f6
  91:	6a 01                	push   $0x1
  93:	e8 d8 04 00 00       	call   570 <printf>
    set_limit(100);
  98:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  9f:	e8 ff 03 00 00       	call   4a3 <set_limit>
    current=uptime();
  a4:	e8 f2 03 00 00       	call   49b <uptime>
  a9:	89 c3                	mov    %eax,%ebx
    cpu_intensive();
  ab:	e8 a0 00 00 00       	call   150 <cpu_intensive>
    finish=uptime();
  b0:	e8 e6 03 00 00       	call   49b <uptime>
    length=finish-current;
    printf(1,"time taken: %d .\n",length);
  b5:	83 c4 0c             	add    $0xc,%esp
    length=finish-current;
  b8:	29 d8                	sub    %ebx,%eax
    printf(1,"time taken: %d .\n",length);
  ba:	50                   	push   %eax
  bb:	68 d1 08 00 00       	push   $0x8d1
  c0:	6a 01                	push   $0x1
  c2:	e8 a9 04 00 00       	call   570 <printf>
    printf(1,"cpu limit : 30%% \n");
  c7:	58                   	pop    %eax
  c8:	5a                   	pop    %edx
  c9:	68 09 09 00 00       	push   $0x909
  ce:	6a 01                	push   $0x1
  d0:	e8 9b 04 00 00       	call   570 <printf>
    set_limit(100);
  d5:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  dc:	e8 c2 03 00 00       	call   4a3 <set_limit>
    current=uptime();
  e1:	e8 b5 03 00 00       	call   49b <uptime>
  e6:	89 c3                	mov    %eax,%ebx
    cpu_intensive();
  e8:	e8 63 00 00 00       	call   150 <cpu_intensive>
    finish=uptime();
  ed:	e8 a9 03 00 00       	call   49b <uptime>
    length=finish-current;
    printf(1,"time taken: %d .\n",length);
  ...
  f5:	29 d8                	sub    %ebx,%eax
    printf(1,"time taken: %d .\n",length);
  f7:	50                   	push   %eax
  f8:	68 d1 08 00 00       	push   $0x8d1
  fd:	6a 01                	push   $0x1
  ff:	e8 6c 04 00 00       	call   570 <printf>
    printf(1,"cpu limit : 10%% \n");
 104:	59                   	pop    %ecx
 105:	5b                   	pop    %ebx
 106:	68 1c 09 00 00       	push   $0x91c
 10b:	6a 01                	push   $0x1
 10d:	e8 5e 04 00 00       	call   570 <printf>
    set_limit(100);
 112:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
 119:	e8 85 03 00 00       	call   4a3 <set_limit>
    current=uptime();
 11e:	e8 78 03 00 00       	call   49b <uptime>
 123:	89 c3                	mov    %eax,%ebx
    cpu_intensive();
 125:	e8 26 00 00 00       	call   150 <cpu_intensive>
    finish=uptime();
 12a:	e8 6c 03 00 00       	call   49b <uptime>
    length=finish-current;
    printf(1,"time taken: %d .\n",length);
 ...
 132:	29 d8                	sub    %ebx,%eax
    printf(1,"time taken: %d .\n",length);
 134:	50                   	push   %eax
 135:	68 d1 08 00 00       	push   $0x8d1
 13a:	6a 01                	push   $0x1
 13c:	e8 2f 04 00 00       	call   570 <printf>


    exit();  
 141:	e8 bd 02 00 00       	call   403 <exit>
...
void cpu_intensive() {  
 ...
 169:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        sum += i;   
 170:	8b 4d f0             	mov    -0x10(%ebp),%ecx
 173:	8b 5d f4             	mov    -0xc(%ebp),%ebx
 176:	01 c1                	add    %eax,%ecx
 178:	11 d3                	adc    %edx,%ebx
    for (long long i = 0; i < 10000000; i++) {  
 17a:	83 c0 01             	add    $0x1,%eax
        sum += i;   
 17d:	89 4d f0             	mov    %ecx,-0x10(%ebp)
    for (long long i = 0; i < 10000000; i++) {  
 180:	83 d2 00             	adc    $0x0,%edx
        sum += i;   
 183:	89 5d f4             	mov    %ebx,-0xc(%ebp)
    for (long long i = 0; i < 10000000; i++) {  
 186:	89 c3                	mov    %eax,%ebx
 188:	81 f3 80 96 98 00    	xor    $0x989680,%ebx
 18e:	89 d1                	mov    %edx,%ecx
 190:	09 d9                	or     %ebx,%ecx
 192:	75 dc                	jne    170 <cpu_intensive+0x20>
    printf(1, "Computation finished with sum: %lld\n", sum);  
 194:	8b 45 f0             	mov    -0x10(%ebp),%eax
 197:	8b 55 f4             	mov    -0xc(%ebp),%edx
 19a:	52                   	push   %edx
 19b:	50                   	push   %eax
 19c:	68 98 08 00 00       	push   $0x898
 1a1:	6a 01                	push   $0x1
 1a3:	e8 c8 03 00 00       	call   570 <printf>
}  
...
000004ab <increase_memory_usage>:
SYSCALL(increase_memory_usage)
 ...
 4cc:	89 d1                	mov    %edx,%ecx
{
 ...
 4f9:	0f b6 92 90 09 00 00 	movzbl 0x990(%edx),%edx
 ...
 579:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e9:	ff 24 85 38 09 00 00 	jmp    *0x938(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6f7:	90                   	nop
          s = "(null)";
 6f8:	ba 2f 09 00 00       	mov    $0x92f,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 711:	a1 60 0c 00 00       	mov    0xc60,%eax
{
 ...
 751:	5b                   	pop    %ebx
  freep = p;
 752:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 758:	5e                   	pop    %esi
 759:	5f                   	pop    %edi
 75a:	5d                   	pop    %ebp
 ...
 789:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 78c:	89 15 60 0c 00 00    	mov    %edx,0xc60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7ac:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ef:	73 4f                	jae    840 <malloc+0xa0>
    ...
    if(p == freep)
 7f1:	8b 3d 60 0c 00 00    	mov    0xc60,%edi
 ...
 81a:	e8 f1 fe ff ff       	call   710 <free>
  return freep;
 81f:	8b 15 60 0c 00 00    	mov    0xc60,%edx
 ...
 84c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 84f:	89 15 60 0c 00 00    	mov    %edx,0xc60
}
 ...
 85f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 860:	c7 05 60 0c 00 00 64 	movl   $0xc64,0xc60
 867:	0c 00 00 
    base.s.size = 0;
 86a:	bf 64 0c 00 00       	mov    $0xc64,%edi
    base.s.ptr = freep = prevp = &base;
 86f:	c7 05 64 0c 00 00 64 	movl   $0xc64,0xc64
 876:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 879:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 87b:	c7 05 68 0c 00 00 00 	movl   $0x0,0xc68
 882:	00 00 00 
    if(p->s.size >= nunits){
